...
🔄 Working Principle
Sensors continuously measure water parameters
Data is sent to microcontroller
Microcontroller processes and formats the data
IoT module uploads data to cloud/server
Dashboard displays live readings
Alerts are triggered if values exceed thresholds
📈 Data Flow
Sensor Data → ADC Conversion → Microcontroller Processing 
→ WiFi Transmission → Cloud Storage → Visualization Dashboard
...
git clone https://github.com/lucifer55555555/Iot-water-monitoring.git
